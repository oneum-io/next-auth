 ...
 *
 * :::caution Note
 * Although `@oneum-io/core` _is_ framework/runtime agnostic, an adapter might rely on a client/ORM package,
 ...
 * ```
 *
 * Then, you can import this submodule from `@oneum-io/core/adapters`.
 *
 * ## Usage
 *
