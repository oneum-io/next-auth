...
import ForwardEmail from "@oneum-io/qwik/providers/forwardemail"
...
import ForwardEmail from "@oneum-io/sveltekit/providers/forwardemail"
...
```ts filename="/src/routes/plugin@auth.ts"
import { QwikAuth$ } from "@oneum-io/qwik"
import Resend from "@oneum-io/qwik/providers/resend"
...
```ts filename="./src/auth.ts"
import SvelteKitAuth from "@oneum-io/sveltekit"
import Resend from "@oneum-io/sveltekit/providers/resend"
...
```ts filename="/src/routes/plugin@auth.ts"
import { QwikAuth$ } from "@oneum-io/qwik"
import Sendgrid from "@oneum-io/qwik/providers/sendgrid"
...
```ts filename="./src/auth.ts"
import SvelteKitAuth from "@oneum-io/sveltekit"
import Sendgrid from "@oneum-io/sveltekit/providers/sendgrid"
...
```ts filename="/src/routes/plugin@auth.ts"
import { QwikAuth$ } from "@oneum-io/qwik"
import Postmark from "@oneum-io/qwik/providers/postmark"
...
```ts filename="./src/auth.ts"
import SvelteKitAuth from "@oneum-io/sveltekit"
import Postmark from "@oneum-io/sveltekit/providers/postmark"
...
```ts filename="./src/auth.ts"
import SvelteKitAuth from "@oneum-io/sveltekit"
import Loops from "@oneum-io/sveltekit/providers/loops"
import {
  AUTH_LOOPS_KEY,
...
```ts filename="/src/routes/plugin@auth.ts"
import { QwikAuth$ } from "@oneum-io/qwik"
import Mailgun from "@oneum-io/qwik/providers/mailgun"
...
```ts filename="./src/auth.ts"
import SvelteKitAuth from "@oneum-io/sveltekit"
import Mailgun from "@oneum-io/sveltekit/providers/mailgun"
