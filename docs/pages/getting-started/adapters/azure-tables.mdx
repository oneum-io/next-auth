...
```bash npm2yarn
npm install @oneum-io/azure-tables-adapter
```
...
import { TableStorageAdapter } from "@oneum-io/azure-tables-adapter"
...
import SvelteKitAuth, { type AuthConfig } from "@oneum-io/sveltekit"
import { TableStorageAdapter } from "@oneum-io/azure-tables-adapter"
import { AzureNamedKeyCredential, TableClient } from "@azure/data-tables"
...
import ExpressAuth, { type AuthConfig } from "@oneum-io/express"
import { TableStorageAdapter } from "@oneum-io/azure-tables-adapter"
import { AzureNamedKeyCredential, TableClient } from "@azure/data-tables"
