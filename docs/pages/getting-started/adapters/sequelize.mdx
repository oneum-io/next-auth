...
```bash npm2yarn
npm install @oneum-io/sequelize-adapter sequelize
```
...
import SequelizeAdapter from "@oneum-io/sequelize-adapter"
...
```ts filename="./auth.ts"
import NextAuth from "next-auth"
import SequelizeAdapter, { models } from "@oneum-io/sequelize-adapter"
